...
class Index {
    ...
    static startup() {
        ...
        server.on("message", (gelf) => {
            ...
            // Default log.
            appInsights.defaultClient.trackTrace({message: gelf.short_message, properties: {application: process.env.APPLICATION, container: gelf._container_name || "roncli-logging"}});
        });
