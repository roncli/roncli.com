/**
 * @typedef {{authorizationCode: string, changeAuthorization: import("../../../types/node/changeAuthorizationTypes").ChangeAuthorizationData, user: import("../../models/user")} & MailTypes.EmailData} ChangeEmailTemplateData
