        ...
        admin.fetch({
            ...
            error: function(xhr, error) {
                ...
                if (error && error.body && error.body.error) {
                    ...
                    message = "There was a server error clearing the blog caches.  Please try again later.";
                }
        ...
        admin.fetch({
            ...
            error: function(xhr, error) {
                ...
                if (error && error.body && error.body.error) {
                    ...
                    message = "There was a server error modering the comment.  Please try again later.";
                }
