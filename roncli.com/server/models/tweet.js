            ...
            tweets = data.map(function(tweet) {
                return {
                    ...
                    html: (tweet.retweeted_status ? tweet.retweeted_status.text : tweet.text)
                        ...
                        .replace(/^((?:[ ])*)(@([a-zA-Z0-9_]{1,20}))(.*?)/g, "$1<a target=\"_blank\" href=\"https://twitter.com/$3\">$2</a>$4")
                        .replace(/(.*?)(^|[^a-zA-Z0-9_>])(@([a-zA-Z0-9_]{1,20}))((?=(.|$)).*?)/g, "$1$2<a href=\"https://twitter.com/$4\">$3</a>$5")
                        .replace(/(.*?)(^|[^a-zA-Z0-9&\/]+)(#|\uFF03)([a-zA-Z0-9_]*[a-zA-Z_]+#*)(.*?)/g, "$1$2<a target=\"_blank\" href=\"https://twitter.com/search?q=%23$4\">$3$4</a>$5")
                };
            });
